	...
	return (function e(t, n, r) {
			...
			module.exports = {
				createCSS: function(document, styles, sheet) {
					...
					if (!styleNode.styleSheet) {
						...
						keepOldStyleNode = (oldStyleNode !== null && oldStyleNode.childNodes.length > 0 && styleNode.childNodes.length >
							0 &&
		...
		8: [function(require, module, exports) {
			module.exports = function(less, options) {
				...
				// 0 - None
				// Defaults to 2
				options.logLevel = typeof options.logLevel !== 'undefined' ? options.logLevel : (options.env ===
					'development' ? logLevel_info : logLevel_error);
		...
		18: [function(require, module, exports) {
			module.exports = function(environment) {
				...
				functionRegistry.add("data-uri", function(mimetypeNode, filePathNode) {
					...
					return new URL(new Quoted('"' + uri + '"', uri, false, this.index, this.currentFileInfo), this.index, this
						.currentFileInfo);
				});
			};
		...
		25: [function(require, module, exports) {
			...
			var minMax = function(isMin, args) {
				...
				for (i = 0; i < args.length; i++) {
					...
					currentUnified = current.unit.toString() === "" && unitClone !== undefined ? new Dimension(current.value,
						unitClone).unify() : current.unify();
					unit = currentUnified.unit.toString() === "" && unitStatic !== undefined ? unitStatic : currentUnified.unit.toString();
					unitStatic = unit !== "" && unitStatic === undefined || unit !== "" && order[0].unify().unit.toString() ===
						"" ? unit : unitStatic;
					...
					referenceUnified = order[j].unit.toString() === "" && unitClone !== undefined ? new Dimension(order[j].value,
			...
			module.exports = function(environment) {
				...
				functionRegistry.add("svg-gradient", function(direction) {
					...
					for (i = 0; i < stops.length; i += 1) {
						...
						if (!(color instanceof Color) || (!((i === 0 || i + 1 === stops.length) && position === undefined) && !(
								position instanceof Dimension))) {
							throwArgumentDescriptor();
						}
						positionValue = position ? position.toCSS(renderEnv) : i === 0 ? "0%" : "100%";
						alpha = color.alpha;
						returner += '<stop offset="' + positionValue + '" stop-color="' + color.toRGB() + '"' + (alpha < 1 ?
							' stop-opacity="' + alpha + '"' : '') + '/>';
					}
					...
					return new URL(new Quoted("'" + returner + "'", returner, false, this.index, this.currentFileInfo), this.index,
		...
		29: [function(require, module, exports) {
			...
			module.exports = function(environment) {
				 ...
				 */
				ImportManager.prototype.push = function(path, tryAppendLessExtension, currentFileInfo, importOptions,
					callback) {
					...
					var fileManager = environment.getFileManager(path, currentFileInfo.currentDirectory, this.context,
						environment);
		...
		36: [function(require, module, exports) {
			...
			module.exports = function() {
				...
				parserInput.restore = function(possibleErrorMessage) {
					...
					if (parserInput.i > furthest || (parserInput.i === furthest && possibleErrorMessage && !
		...
		37: [function(require, module, exports) {
			...
			var Parser = function Parser(context, imports, fileInfo) {
				...
				function expect(arg, msg, index) {
					...
					var result = (Object.prototype.toString.call(arg) === '[object Function]') ? arg.call(parsers) : parserInput
						.$re(arg);
					if (result) {
						return result;
					}
				...
				return {
					...
					parsers: parsers = {
						...
						selector: function(isLess) {
							...
							while ((isLess && (extendList = this.extend())) || (isLess && (when = parserInput.$str("when"))) || (e =
									this.element())) {
								if (when) {
		...
		54: [function(require, module, exports) {
			...
			DetachedRuleset.prototype.callEval = function(context) {
				return this.ruleset.eval(this.frames ? new contexts.Eval(context, this.frames.concat(context.frames)) :
					context);
			};
		...
		55: [function(require, module, exports) {
			...
			Dimension.prototype.genCSS = function(context, output) {
				if ((context && context.strictUnits) && !this.unit.isSingular()) {
					throw new Error("Multiple units in dimension. Correct the units or use the unit function. Bad unit: " + this
						.unit.toString());
				}
		...
		67: [function(require, module, exports) {
			...
			Definition.prototype.eval = function(context) {
				return new Definition(this.name, this.params, this.rules, this.condition, this.variadic, this.frames ||
					context.frames.slice(0));
			};
		...
		73: [function(require, module, exports) {
			...
			Rule.prototype.genCSS = function(context, output) {
				...
				output.add(this.important + ((this.inline || (context.lastRule && context.compress)) ? "" : ";"), this.currentFileInfo,
					this.index);
			};
			...
			Ruleset.prototype.joinSelector = function(paths, context, selector) {
				...
				function addReplacementIntoPath(beginningPath, addPath, replacedElement, originalSelector) {
					...
					if (addPath.length > 0) {
						...
						newJoinedSelector.elements.push(new Element(combinator, parentEl.value, replacedElement.index,
			...
			ProcessExtendsVisitor.prototype = {
				...
				doExtendChaining: function(extendsList, extendsListTarget, iterationCount) {
					...
					if (extendsToAdd.length) {
						...
						// d extending e...
						return extendsToAdd.concat(extendVisitor.doExtendChaining(extendsToAdd, extendsListTarget, iterationCount +
							1));
					} else {
						return extendsToAdd;
					}
							...
							for (i = 0; i < potentialMatches.length; i++) {
								...
								if (potentialMatch) {
									...
									if (potentialMatch.finished &&
										(!extend.allowAfter &&
											(hackstackElementIndex + 1 < hackstackSelector.elements.length || haystackSelectorIndex + 1 <
					...
					if (elementValue1 instanceof tree.Selector) {
						...
						for (var i = 0; i < elementValue1.elements.length; i++) {
							if (elementValue1.elements[i].combinator.value !== elementValue2.elements[i].combinator.value) {
								if (i !== 0 || (elementValue1.elements[i].combinator.value || ' ') !== (elementValue2.elements[i].combinator
										.value || ' ')) {
									return false;
								}
							}
